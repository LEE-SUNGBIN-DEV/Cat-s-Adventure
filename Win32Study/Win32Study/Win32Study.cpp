#include <vector>
// Win32Study.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
#include "framework.h"
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_WIN32STUDY, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_WIN32STUDY);
